...
/**
 * Что это: раздел настройки автоматического сжатия контекста и лёгких вспомогательных моделей.
 * Зачем нужно: удерживает ограничения input-полей рядом с UI и не даёт отправить в extension некорректные значения.
 */
