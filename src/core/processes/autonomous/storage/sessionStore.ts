...
import { globalWorkspaceAutonomousSessionsDir } from '../../../entities/storage/storage';
...
export class AutonomousSessionStore {
  ...
  private getSessionPath(sessionId: string): string {
    return path.join(this.rootPath, assertRepositoryId(sessionId, 'autonomous session'));
  }
}
