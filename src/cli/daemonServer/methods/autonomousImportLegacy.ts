...
export async function autonomousImportLegacy(this: AistDaemonServer): Promise<DaemonAutonomousImportLegacyResult> {
  return {
    operationId: this.idFactory(),
    state: await this.autonomousBackend.importLegacyDefinitions()
  };
}
